...
void menus(Texture2D hiro,Texture2D background, Texture2D grass, Texture2D stone_1, Texture2D stone_2, Texture2D stone_3, Texture2D bush_1, Texture2D bush_2, Texture2D bush_3){
    if(menuStateSelected == 0){
        DrawTexture(background,0,0,WHITE);
        Char(x_cellSize,y_cellSize,hiro);
        InitiateBoard(grass, stone_1, stone_2, stone_3, bush_1, bush_2, bush_3);
